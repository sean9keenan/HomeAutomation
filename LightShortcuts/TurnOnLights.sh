...
# For remote speakers on
# To compile to apple script:
#  osacompile -e 'do shell script "/opt/local/bin/wget --delete-after \"http://link.skeenan.com/arduinoAction/Speakers_On\""' -o ./speakersOn.scpt

# For remote Projector on
# To compile to apple script:
#  osacompile -e 'do shell script "/opt/local/bin/wget --delete-after \"http://link.skeenan.com/arduinoAction/Projector_On\""' -o ./projectorOn.scpt
