...
var getServerAddr = window.getCookie("serverAddr");
if (getServerAddr != null && getServerAddr != ''){
  window.setNewSocketAddress(getServerAddr);
} else {
  window.setNewSocketAddress(window.socketAddress);
}